        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-tax-class">Kur</label>
                <div class="col-sm-10">
                  <select name="currency_id" id="input-tax-class" class="form-control">
                    <option value="0"><?php echo $text_none; ?></option>
                    <?php foreach ($currency as $currencys) { ?>
                    <?php if ($currencys['currency_id'] == $currency_id) { ?>
                    <option value="<?php echo $currencys['currency_id']; ?>" selected="selected"><?php echo $currencys['title']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $currencys['currency_id']; ?>"><?php echo $currencys['title']; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
                </div>
