...
class Cart {
	...
	$product_currency_query = $this->db->query("SELECT value FROM " . DB_PREFIX . "currency WHERE currency_id = '" .$product_query->row['currency_id'] . "'");
	$curr_value = $product_currency_query->row['value'];
	$price = ($price/$curr_value);
	//echo $curr_value.'<br>';
